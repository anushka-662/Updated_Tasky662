...
const htmlTaskContent = ({ id, title, description, type, url }) => `
  <div class='col-md-4 col-lg-3 col-xs-0.5 mt-3' id=${id} key=${id}>
    <div class='card shadow-sm task__card'>
      ...
      <div class='card-footer'>
        ...
        <button 
        type='button' 
        class='btn bg-danger float-right text-white' 
       
        id=${id}
        onclick='changeStatus.apply(this,arguments)'
        >
          Pending
        </button>
...
const handleSubmit = (event) => {
  ...
  if (input.type === "") {
    return alert("Please enter the Task Date");
  }
  ...
  swal({
    ...
    text: "You have successfully created your task !",
    icon: "success",
    button: "OK!",
  });
};
...
const changeStatus = (e) => {
  ...
  change = parentNode.childNodes[5].childNodes[3];

  change.innerHTML = "Done!!";
  change.setAttribute("class", "btn bg-success float-right text-white");
